<?php
/* ----------------------------------------------------------------------
 * app/controllers/find/SearchMovementsAdvancedController.php : controller for "advanced" movement search request handling
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
	...
	require_once(__CA_MODELS_DIR__."/ca_sets.php");
 	...
 	class SearchMovementsAdvancedController extends BaseAdvancedSearchController {
 		# -------------------------------------------------------
 		/**
 		 ...
 		 * (eg. ObjectSearch for objects, MovementSearch for movements) and pass it to BaseAdvancedSearchController->Index() 
 		 */ 
