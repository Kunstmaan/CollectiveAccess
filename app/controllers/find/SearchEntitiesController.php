<?php
/* ----------------------------------------------------------------------
 * app/controllers/find/FindEntitiesController.php : controller for entity search request handling
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 	...
 	class SearchEntitiesController extends BaseSearchController {
 		...
 		public function Form($pa_options=null) {
 			...
 			return parent::Form(new EntitySearch(), $pa_options);
 		}
 		# -------------------------------------------------------
 		/**
 		...
 		public function Tools($pa_parameters) {
 			...
 			return parent::Tools($pa_parameters, new EntitySearch());
 		}
 		# -------------------------------------------------------
 	}
 ?>