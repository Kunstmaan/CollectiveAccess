	...
	class MediaAttributeValue extends AttributeValue implements IAttributeValue {
		...
		public function getDisplayValue($pa_options=null) {
			...
			if ($vs_url = $this->opo_media_info_coder->getMediaUrl($this->opa_media_data, 'original')) {
				...
				$vs_val = "<div class='attributeMediaInfoContainer'><div class='attributeMediaThumbnail'>{$vs_tag}</div><div class='attributeMediaFileName'>{$vs_filename}</div><div class='attributeMediaInfo'>{$vs_dimensions}</div></div>";
			}
			return $vs_val;
		}
 		# ------------------------------------------------------------------
