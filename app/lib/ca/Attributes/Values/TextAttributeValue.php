	...
	class TextAttributeValue extends AttributeValue implements IAttributeValue {
		...
		public function getDisplayValue($pa_options=null) {
 		...
 		public function htmlFormElement($pa_element_info, $pa_options=null) {
 			...
 			$vn_width = (isset($pa_options['width']) && $pa_options['width'] > 0) ? $pa_options['width'] : $va_settings['fieldWidth'];
 			$vn_height = (isset($pa_options['height']) && $pa_options['height'] > 0) ? $pa_options['height'] : $va_settings['fieldHeight'];
		...
		jQuery('.jqueryCkeditor').ckeditor(
			{
