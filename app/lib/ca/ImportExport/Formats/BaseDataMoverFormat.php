 ...
 */
  ...
  */
	...
	class BaseDataMoverFormat {
		 ...
		 *
		 */
		public function add($pa_values) {
			if (!is_array($pa_values) || !sizeof($pa_values)) { return false; }
			$this->opa_records[] = $pa_values;
		...
		public function getOutputMimetype() {
			global $g_ca_data_import_export_format_definitions;
		 	...
		 	return isset($g_ca_data_import_export_format_definitions[$this->ops_name]['output_mimetype']) ? $g_ca_data_import_export_format_definitions[$this->ops_name]['output_mimetype'] : null;
		}
		# -------------------------------------------------------
		/**
		 *
		...
		public function getFileExtension() {
			global $g_ca_data_import_export_format_definitions;
		 	...
		 	return isset($g_ca_data_import_export_format_definitions[$this->ops_name]['file_extension']) ? $g_ca_data_import_export_format_definitions[$this->ops_name]['file_extension'] : null;
		}
		# -------------------------------------------------------
	}
?>