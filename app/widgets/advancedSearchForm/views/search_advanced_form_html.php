...
<?php
			...
			print "<h3>".unicode_ucfirst($o_dm->getTableProperty($t_form->get('table_num'), 'NAME_PLURAL')).": ".$t_form->getLabelForDisplay()."</h3>\n";
...
<?php 
			print "<div style='float: right;'>".caFormSubmitButton($this->request, __CA_NAV_BUTTON_SEARCH__, _t("Search"), 'AdvancedSearchForm').'<br/>'.
				caJSButton($this->request, __CA_NAV_BUTTON_CANCEL__, _t("Reset"), 'AdvancedSearchForm', array(), array('onclick' => 'caAdvancedSearchFormReset()'))."</div>\n";
