<?php
/** ---------------------------------------------------------------------
 * app/models/ca_search_form_labels.php : table access class for table ca_search_form_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_search_form_labels'] = array(
...
class ca_search_form_labels extends BaseLabel {
	...
	protected $TABLE = 'ca_search_form_labels';
	...
	protected $LIST_HEADING = 'Search form labels';

	# What you'd call a single record from this table (eg. a "person")
	protected $NAME_SINGULAR;

	# What you'd call more than one record from this table (eg. "people")
	protected $NAME_PLURAL = 'search form labels';
	...
	protected $LABEL_SUBJECT_TABLE = 'ca_search_forms';
