<?php
/** ---------------------------------------------------------------------
 * app/models/ca_bundle_mapping_labels.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_bundle_mapping_labels'] = array(
 	'NAME_SINGULAR' 	=> _t('bundle mapping name'),
 	'NAME_PLURAL' 		=> _t('bundle mapping names'),
 	'FIELDS' => array(
		'label_id' => array(
		...
		'name' => array(
				...
				'IS_NULL' => false,
				'DEFAULT' => '',
				'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Name of mapping'),
		...
		'description' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Description'), 'DESCRIPTION' => _t('Description of mapping'),
		...
		'locale_id' => array(
				...
				'LABEL' => _t('Locale'), 'DESCRIPTION' => _t('Locale of mapping name'),
		),
		'source_info' => array(
...
class ca_bundle_mapping_labels extends BaseLabel {
	# ---------------------------------
	...
	protected $TABLE = 'ca_bundle_mapping_labels';
	...
	protected $LABEL_SUBJECT_TABLE = 'ca_bundle_mappings';
