<?php
/** ---------------------------------------------------------------------
 * app/models/ca_task_queue.php : table access class for table ca_task_queue
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_task_queue'] = array(
 	...
 	'FIELDS' 			=> array(
 		'task_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'Task id', 'DESCRIPTION' => 'Identifier for Task'
		),
		'user_id' => array(
		...
		'row_key' => array(
				...
				'IS_NULL' => true, 
				'DEFAULT' => '',
				'LABEL' => 'Row key', 'DESCRIPTION' => 'Row key',
		...
		'entity_key' => array(
				...
				'IS_NULL' => true, 
				'DEFAULT' => '',
				'LABEL' => 'Entity key', 'DESCRIPTION' => 'Entity key',
				'BOUNDS_LENGTH' => array(0,32)
		),
		'created_on' => array(
		...
		'completed_on' => array(
				...
				'IS_NULL' => true, 
				'DEFAULT' => '',
				'LABEL' => _t('Completed on'), 'DESCRIPTION' => _t('Completed on')
		),
		'priority' => array(
				'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD, 
				'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Priority'), 'DESCRIPTION' => _t('Priority'),
		...
		'handler' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Handler'), 'DESCRIPTION' => _t('Handler'),
		...
		'parameters' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Parameters'), 'DESCRIPTION' => _t('Parameters'),
...
class ca_task_queue extends BaseModel {
	...
	protected $LIST_FIELDS = array('row_key');
	...
	protected $ORDER_BY = array('row_key');
