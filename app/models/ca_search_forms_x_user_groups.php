<?php
/** ---------------------------------------------------------------------
 * app/models/ca_search_forms_x_user_groups.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_search_forms_x_user_groups'] = array(
 	'NAME_SINGULAR' 	=> _t('search forms ⇔ group association'),
 	'NAME_PLURAL' 		=> _t('search forms ⇔ group associations'),
 	'FIELDS' 			=> array(
		'relation_id' => array(
		...
		'access' => array(
				...
				'LABEL' => _t('Access'), 'DESCRIPTION' => _t('Indicates group&apos;s level of access to the form. ')
		)
	)
);
...
class ca_search_forms_x_user_groups extends BaseRelationshipModel {
	...
	protected $TABLE = 'ca_search_forms_x_user_groups';
	...
	# --- Relationship info
	# ------------------------------------------------------
	protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_bundle_displays';
