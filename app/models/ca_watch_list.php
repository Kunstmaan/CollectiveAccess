...
BaseModel::$s_ca_models_definitions['ca_watch_list'] = array(
 	...
 	'FIELDS' 			=> array(
 		'watch_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'Unique id for this watched item', 'DESCRIPTION' => 'Unique id for this watched item'
		),
		'table_num' => array(
...
class ca_watch_list extends BaseModel {
	...
	public function getWatchedItems($pn_user_id, $pn_table_num = null){
		...
		$q_watched_items = $o_db->query("SELECT watch_id, row_id, table_num from ca_watch_list WHERE user_id = ? $sql ORDER BY watch_id DESC", $pn_user_id);
