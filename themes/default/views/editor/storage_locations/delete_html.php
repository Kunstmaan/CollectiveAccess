...
<?php
	if (!$this->getVar('confirmed')) {
		...
		print caDeleteWarningBox($this->request, $this->getVar('subject_name'), 'editor/storage_locations', 'StorageLocationEditor', 'Edit/'.$this->request->getActionExtra(), array('location_id' => $vn_location_id));
	}
?>
</div>