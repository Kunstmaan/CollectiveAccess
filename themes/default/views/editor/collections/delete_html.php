...
<?php
	if (!$this->getVar('confirmed')) {
		...
		print caDeleteWarningBox($this->request, $this->getVar('subject_name'), 'editor/collections', 'CollectionEditor', 'Edit/'.$this->request->getActionExtra(), array('collection_id' => $vn_collection_id));
	}
?>
</div>