...
<?php
	if (!$this->getVar('confirmed')) {
		...
		print caDeleteWarningBox($this->request, $this->getVar('subject_name'), 'editor/movements', 'MovementEditor', 'Edit/'.$this->request->getActionExtra(), array('movement_id' => $vn_movement_id));
	}
?>
</div>