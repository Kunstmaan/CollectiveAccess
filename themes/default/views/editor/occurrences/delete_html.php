...
<?php
	if (!$this->getVar('confirmed')) {
		...
		print caDeleteWarningBox($this->request, $this->getVar('subject_name'), 'editor/occurrences', 'OccurrenceEditor', 'Edit/'.$this->request->getActionExtra(), array('occurrence_id' => $vn_occurrence_id));
	}
?>
</div>