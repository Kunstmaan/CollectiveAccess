...
<?php
	if (!$this->getVar('confirmed')) {
		...
		print caDeleteWarningBox($this->request, $this->getVar('subject_name'), 'editor/objects', 'ObjectEditor', 'Edit/'.$this->request->getActionExtra(), array('object_id' => $vn_object_id));
	}
?>
</div>