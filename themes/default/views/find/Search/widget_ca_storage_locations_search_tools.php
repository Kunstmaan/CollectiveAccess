...
<h3><?php print _t("History"); ?>:
	<div>
<?php
		print caFormTag($this->request, 'Index', 'caSearchHistoryForm', 'find/SearchStorageLocations', 'post', 'multipart/form-data', '_top', array('disableUnsavedChangesWarning' => true)); 
...
?>
	...
	<div>
<?php
		print caFormTag($this->request, 'Index', 'caSearchSetsForm', 'find/SearchStorageLocations', 'post', 'multipart/form-data', '_top', array('disableUnsavedChangesWarning' => true)); 
