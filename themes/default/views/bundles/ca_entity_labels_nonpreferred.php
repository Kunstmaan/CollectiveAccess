						...
						<table>
							...
							<tr>
								<td>
									...
									<?php print '<div class="formLabel">'.$t_label->htmlFormElement('type_id', "^LABEL<br/>^ELEMENT", array('classname' => 'labelType', 'id' => "{fieldNamePrefix}type_id_{n}", 'name' => "{fieldNamePrefix}type_id_{n}", "value" => "{type_id}", 'no_tooltips' => true)).'</div>'; ?>
								</td>
								<td>
