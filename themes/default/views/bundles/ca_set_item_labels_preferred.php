<?php
/* ----------------------------------------------------------------------
 * bundles/ca_set_item_labels_preferred.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
?>
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print $t_label->htmlFormElement('caption', "^ELEMENT", array('name' => "{fieldNamePrefix}caption_{n}", 'id' => "{fieldNamePrefix}caption_{n}", "value" => "{{caption}}", 'no_tooltips' => true, 'textAreaTagName' => 'textentry')); ?>
			<br/>
...
<script type="text/javascript">
	caUI.initLabelBundle('#<?php print $vs_id_prefix; ?>Labels', {
		...
		templateValues: ['caption', 'locale_id'],
