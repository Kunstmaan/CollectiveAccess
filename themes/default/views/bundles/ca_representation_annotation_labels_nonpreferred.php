<?php
/* ----------------------------------------------------------------------
 * bundles/ca_representation_annotation_labels_nonpreferred.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
?>
	...
	<div class="bundleContainer">
		...
		<div class='button caAddLabelButton'><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__); ?> <?php print _t("Add label"); ?></a></div>
	</div>
</div>
