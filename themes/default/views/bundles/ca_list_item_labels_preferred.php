						...
						<table>
							...
							<tr>
								<td>
									...
									<?php print $t_label->htmlFormElement('type_id', "^LABEL ^ELEMENT", array('classname' => 'labelType', 'id' => "{fieldNamePrefix}type_id_{n}", 'name' => "{fieldNamePrefix}type_id_{n}", "value" => "{type_id}", 'no_tooltips' => true, 'list_code' => 'list_item_label_types_preferred', 'dont_show_null_value' => true, 'hide_select_if_no_options' => true)).'</div>'; ?>
								</td>
							<tr>
						</table>
					</td>
