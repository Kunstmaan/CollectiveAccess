	...
	if (sizeof($va_reps)) {
		foreach ($va_reps as $va_rep) {
			...
			$va_inital_values[$va_rep['representation_id']] = array(
				...
				'num_multifiles' => ($vn_num_multifiles ? (($vn_num_multifiles == 1) ? _t('+ 1 additional file') : _t('+ %1 additional files', $vn_num_multifiles)) : ''),
			...
			<table class="objectRepresentationListItem">
				<tr >
					...
					<td colspan="1" align="right" valign="bottom" width="300px" style="padding: 5px 20px 0px 0px;">
							<div style="width:300px; overflow:hidden; padding:0px; margin:0px;"><a title="{filename}" style="font-weight:bold; color:#000000;"><i>{filename}</i></a></div>{type} {dimensions} {num_multifiles}
...
?>
	...
	<div class="bundleContainer">
		...
		<div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__); ?> <?php print _t("Add representation"); ?> &rsaquo;</a></div>
	</div>
</div>
