 ...
 */
	...
	$vs_set_type_menu = '<div class="sf-small-menu form-header-button rounded">'.
						...
						'</div>';
	//$vs_set_type_menu = caNavHeaderButton($this->request, __CA_NAV_BUTTON_ADD__, _t('New display list'), 'manage/bundle_displays', 'BundleDisplayEditor', 'Edit', array('display_id' => 0));
?>
...
<div class="sectionBox">
	<?php 
		print caFormControlBox(
			'<div class="list-filter">Filter: <input type="text" name="filter" value="" onkeyup="$(\'#caBundleList\').caFilterTable(this.value); return false;" size="20"/></div>', 
			'', 
			($this->request->user->canDoAction('can_create_ca_bundle_displays')) ? $vs_set_type_menu : ''
		); 
	?>
