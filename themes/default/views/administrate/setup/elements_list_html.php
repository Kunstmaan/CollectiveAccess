...
<div class="sectionBox">
	<?php
		print caFormControlBox(
			'<div class="list-filter">Filter: <input type="text" name="filter" value="" onkeyup="$(\'#caElementList\').caFilterTable(this.value); return false;" size="20"/></div>',
			'',
			caNavHeaderButton($this->request, __CA_NAV_BUTTON_ADD__, _t("New"), 'administrate/setup', 'Elements', 'Edit', array('element_id' => 0))
		);
	?>
